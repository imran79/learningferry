...
const PassportFacebookAuth_1 = require("../strategy/PassportFacebookAuth");
const moment = require("moment");
const PassportJwtAuth_1 = require("../strategy/PassportJwtAuth");
const PassportLocalAuth_1 = require("../strategy/PassportLocalAuth");
    ...
    constructor() {
        ...
        this.localAuth = (req, res, next) => {
            passport.authenticate('local', (err, user, info) => {
                ...
                if (!user) {
                    return res.status(400).json({ 'message': 'imran check' });
                }
                req.logIn(user, (err) => {
                    if (err) {
                        return next(err);
